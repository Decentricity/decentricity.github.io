...
### Co-Founder and Director | Blocksphere | 2018 - Present

- Lead consulting, training, and solution design in AI, blockchain, and decentralized systems for Indonesian financial institutions, state entities, and enterprises.
- Advise clients on sovereign AI, hybrid cloud, tokenization, digital asset strategy, and enterprise blockchain implementation.
- Design and deliver executive and practitioner programs for corporate and government stakeholders.
- Translate emerging-technology concepts into implementation roadmaps, governance frameworks, and enterprise operating models.

#### Selected Consulting Projects and Engagements

- Delivered advisory, training, and implementation-oriented engagements for organizations including Bank Indonesia, OJK, Kominfo, Peruri, BCA, BNI, BRI, and BPJS Kesehatan.
- Architected a compliance-first digital gold tokenization platform enabling fractional ownership while aligning with OJK requirements.
- Built a blockchain-based e-waste traceability platform providing end-to-end tracking from collection through certified recycling.
- Developed a privacy-preserving governance and voting prototype for an education institution using verifiable on-chain records.
- Led blockchain and AI capability-building programs for enterprise and public-sector stakeholders in Indonesia.
...
### Founder | Myriad.Social | 2020 - 2024
...
### Senior Research Advisor | MIT Digital Currency Initiative | 2022

- Served on the CBDC and Financial Inclusion Research Panel, contributing subject-matter expertise on blockchain, digital currency, and financial inclusion.
- Contributed research and advisory input to policy discussions whose perspectives were reflected in a U.S. CBDC report released during the Biden administration.
- Worked in an international research and policy context on questions related to monetary innovation, inclusion, and digital public infrastructure.

### Co-Founder and Board Member | Blockchain Zoo | circa 2017 - 2020

- Co-founded an early blockchain consulting and solutions company.
...
- Founding member and former Secretary-General of Asosiasi Blockchain Indonesia, contributing to early industry coordination, self-regulation, and public-policy engagement in Indonesia.
- Advisor and consultant to regulators, banks, state-owned enterprises, and ministries on blockchain strategy, crypto-asset regulation, and AI and blockchain convergence.
- Frequent moderator, trainer, and translator of complex technical material for executive, policy, and non-technical audiences.

## Media and Public Communication

### Executive Producer and Special Host | Bloomberg Technoz Podcast - TechnoZone | 2024 - Present

- Executive producer and host of a technology-focused show covering AI, cloud computing, digital transformation, and infrastructure.
- Lead discussions with founders, regulators, and industry leaders on the commercial and policy impact of emerging technologies.
- Extend subject-matter work into public communication for a broader business and policy audience.

## Education

### Walsh College, Michigan | MSc and Doctorate Candidate

- Current double-degree pathway at Walsh College.
- Completed prerequisite matriculation coursework through the University of Texas at Austin postgraduate collaboration with Walsh College.

### Institut Teknologi Bandung | B.Eng., Environmental Engineering | 2008

- Undergraduate final project focused on an expert system for environmental impact analysis reporting, built in Visual Prolog.
...
- Multiple IBM technical certifications, including IBM Blockchain Developer, IBM Watson, and IBM Systems
...
- ETHDenver Hackathon Winner, UN SDG Award for Decentralized Bioinformatics Network, 2022
- CNBC Indonesia Award for blockchain-based medical data innovation, 2022
- Indonesia World Women Leadership Award, 2021
- IBM PureSystems Worldwide Top 11 Super-Seller, 2013

## Publications, Panels, and Selected Work

- Invited speaker, OECD Global Blockchain Policy Forum, 2020
