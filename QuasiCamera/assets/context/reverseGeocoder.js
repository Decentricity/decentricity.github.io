...
export class BigDataCloudReverseGeocoder {
    id = "bigdatacloud";
    async reverse(latitude, longitude, options = {}) {
...
export class CascadingReverseGeocoder {
    primary;
    fallback;
    id;
    constructor(primary = new NominatimReverseGeocoder(), fallback = new BigDataCloudReverseGeocoder()) {
...
export function normalizeNominatimGeocodeJson(data, latitude, longitude) {
...
export function normalizeBigDataCloud(data, latitude, longitude) {
    const response = data;
...
export function mergeReverseGeocodes(primary, fallback) {
...
export function isSparseReverseGeocode(location) {
...
export function needsReverseRefresh(input) {
    ...
    const distance = haversineMeters(input.currentLatitude, input.currentLongitude, input.cached.latitude, input.cached.longitude);
...
export function cloneReverseGeocode(location) {
    return {
...
export function applyAccuracyToReverseGeocode(location, gpsAccuracyMeters) {
...
function hasUsefulLocality(address) {
