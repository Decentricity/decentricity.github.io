...
export class OpenAIObjectAnalyzer {
    keyStore;
    fetchImpl;
    timeoutMs;
    constructor(keyStore = new OpenAIKeyStore(), fetchImpl = globalThis.fetch.bind(globalThis), timeoutMs = OBJECT_ANALYSIS_TIMEOUT_MS) {
...
async function createAnalysisDataUrl(source) {
