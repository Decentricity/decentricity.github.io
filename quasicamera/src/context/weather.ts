import type { GeoContext, WeatherContext } from "../types.js";
...
export class WeatherService {
  ...
  async snapshot(location: GeoContext): Promise<WeatherContext> {
  ...
  private describe(code: number | undefined, rainMm: number, cloudCover: number | undefined): string {
    if (rainMm >= 6) {
      return "Heavy rain";
    }
