export const DOMAIN_VALUES = ["general", "urban", "nature", "tech", "vehicle", "food"];
export const OVERLAY_DENSITY_VALUES = ["minimal", "normal", "full"];
export const ANALYSIS_MODE_VALUES = ["taxonomy", "semantic", "affordance", "risk", "attention"];
export const CONFIDENCE_VALUES = [0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9];
export const SCAN_MODE_VALUES = ["focus", "balanced", "survey"];
export const VIEW_MODE_VALUES = ["live", "freeze"];
...
export function analysisModeLabel(value) {
    return value.toUpperCase();
}
export function confidenceLabel(value) {
    return `${Math.round(value * 100)}`;
}
export function scanModeLabel(value) {
    return value.toUpperCase();
}
export function viewModeLabel(value) {
    return value.toUpperCase();
}
export function scanModeObjectLimit(value) {
    switch (value) {
        case "focus":
            return 4;
        case "survey":
...
export function densityObjectLimit(value) {
    switch (value) {
        case "minimal":
            return 5;
        case "full":
...
function nextCircularDetent(current, detents, delta) {
