export async function createFaceCrops(source, faces) {
    if (faces.length === 0) {
        return [];
    }
...
export function expandedFaceBox(face, imageWidth, imageHeight, widthScale = 1.8, heightScale = 2.2) {
...
function createFaceCrop(source, image, face, index) {
