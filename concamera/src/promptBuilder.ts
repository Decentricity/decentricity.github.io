...
function facePreservationRules(selection: SubjectFaceSelection | undefined): string[] {
...
function subjectFaceSelectionRules(selection: SubjectFaceSelection): string[] {
...
function rollLine(rollDeg: number | null): string {
  if (rollDeg === null) {
...
function poseCompositionRules(context: AntiCameraContext): string[] {
